...
const huesitos_D = preload("res://Assets/NPCs/Dialogo/huesitos.dialogue")

func _ready():
	if GameState.npc_huesitos_done:
		queue_free()
...
func start_dialogue():
	...
	var balloon = DialogueManager.show_dialogue_balloon(huesitos_D, "start")
...
func _on_dialogue_finished():
	...
	GameState.npc_huesitos_done = true
	GameState.magia_huesitos = true
	queue_free()
